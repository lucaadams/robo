...
async def execute_quote_command(message):
    ...
    if image_type == "colour":
        ...
        image = Image.open(
            f"image_commands/quote_images/colourful/{image_options[random.randint(0, 4)]}")
        font = ImageFont.truetype(
            "image_commands/quote_images/fonts/Kiss_Boom.ttf", 130)
        ...
        image = Image.open(
            f"image_commands/quote_images/greyscale/{image_options[random.randint(0, 4)]}")
        font = ImageFont.truetype(
            "image_commands/quote_images/fonts/CaviarDreams.ttf", 50)
